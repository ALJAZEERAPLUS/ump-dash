...
mod tests {
    ...
    fn command_metadata_matrix() {
        ...
        let cases: Vec<(CommandSpec, &str, bool, bool, CollisionPolicy, RefreshSet)> = vec![
            (CommandSpec::GitResetHard, "git reset --hard HEAD", true, false, BlockNew, full),
            (CommandSpec::GitPull, "git pull", false, false, BlockNew, none),
            (CommandSpec::GitPush, "git push", false, false, BlockNew, none),
            (CommandSpec::GitFetch, "git fetch --all --tags", false, false, BlockNew, none),
            (CommandSpec::GitResetHardFetch, "git fetch + reset --hard origin/<branch>", true, false, BlockNew, full),
            (CommandSpec::RnCleanAndroid, "Clean Android (react-native clean)", true, true, CancelPrevious, stale),
            (CommandSpec::RnCleanCocoapods, "Clean CocoaPods (react-native clean)", true, true, CancelPrevious, stale),
            (CommandSpec::RmNodeModules, "Remove node_modules", true, true, CancelPrevious, stale),
            (CommandSpec::YarnInstall, "yarn install", false, true, BlockNew, stale),
            (CommandSpec::YarnPodInstall, "yarn pod-install", false, true, BlockNew, stale),
            (CommandSpec::YarnUnitTests, "yarn unit-tests", false, true, CancelPrevious, none),
            (CommandSpec::YarnJest { filter: String::new() }, "yarn jest <filter>", false, true, CancelPrevious, none),
            (CommandSpec::YarnLint, "yarn lint --quiet --fix", false, true, CancelPrevious, none),
            (CommandSpec::YarnCheckTypes, "yarn check-types --incremental", false, true, CancelPrevious, none),
            (CommandSpec::UmpRunAndroid { device_id: String::new(), variant: None }, "Run Android (UMP)", false, true, CancelPrevious, none),
            (CommandSpec::UmpRunIos { device_id: String::new(), variant: None }, "Run iOS (UMP)", false, true, CancelPrevious, none),
            (CommandSpec::RnReleaseBuild, "gradlew assembleRelease", false, true, CancelPrevious, none),
            (CommandSpec::AdbInstallApk, "adb install release APK", false, true, CancelPrevious, none),
            (CommandSpec::ShellCommand { command: String::new() }, "shell command", false, true, CancelPrevious, none),
        ];
